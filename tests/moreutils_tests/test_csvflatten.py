...
from csvkitcat.moreutils.csvflatten import CSVFlatten, launch_new_instance, DEFAULT_EOR_MARKER
...
class TestCSVFlatten(CSVKitTestCase, EmptyFileTests):
    ...
    def test_forced_quoting_in_X_mode(self):
        self.assertLines(['examples/dummy.csv', '-X', '42', '-U', '3'], [
            '"fieldname","value"',
            '"a","1"',
            '"b","2"',
            '"c","3"',
    ...
    def test_x_chop(self):
        self.assertLines(['examples/statecodes.csv', '-X', '5'], [
            '"fieldname","value"',
            '"code","IA"',
            '"name","Iowa"',
    ...
    def test_x_chop_field_label(self):
        self.assertLines(['examples/statecodes.csv', '-X', '5', '--chop-labels'], [
            '"fieldname","value"',
            '"code","IA"',
            '"name","Iowa"',
            f'"{DEFAULT_EOR_MARKER}",""',
    ...
    def test_end_of_record_marker_default(self):
        ...
        $,%
        """
        self.assertLines(['examples/tinyvals.csv',], [
            '''fieldname,value''',
            '''alpha,1''',
            '''omega,9''',
            f'''{DEFAULT_EOR_MARKER},''',
    ...
    def test_no_end_of_record_marker(self):
        self.assertLines(['examples/tinyvals.csv', '--eor', ''], [
            '''fieldname,value''',
            '''alpha,1''',
            '''omega,9''',
            '''alpha,a''',
        ...
        self.assertLines(['examples/tinyvals.csv', '--eor', 'none'], [
            '''fieldname,value''',
            '''alpha,1''',
            '''omega,9''',
            '''alpha,a''',
    ...
    def test_custom_end_of_record_marker(self):
        self.assertLines(['examples/tinyvals.csv', '--eor', 'False'], [
            '''fieldname,value''',
            '''alpha,1''',
            '''omega,9''',
            f'''False,''',
