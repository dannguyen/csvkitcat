...
class TestCSVNorm(CSVKitTestCase, ColumnsTests, EmptyFileTests, NamesTests):
    ...
    def test_basic_tab_normalize(self):
        self.assertRows(['examples/tabs.wtf'], [
            ['id', 'val'],
            ['1', 'a'],
            ['2', 'tab b'],
            ['3', 'c 2tab d'],
    ...
    def test_disable_strip(self):
        ...
        "   3 ","    bye    now "
        """
        self.assertRows(['--no-strip', 'examples/strips.csv'], [
            ['id', 'text'],
            ['1', 'hey'],
            ['2 ', 'hello world '],
            [' 3 ', ' bye now '],
    ...
    def test_disable_squeeze_space(self):
        self.assertRows(['--squeeze', 'l', 'examples/strips.csv'], [
            ['id', 'text'],
            ['1', 'hey'],
            ['2', 'hello  world'],
            ['3', 'bye    now'],
    ...
    def test_keep_consecutive_whitespace_oldtest(self):
        self.assertLines(['examples/consec_ws.csv', '--SX'], [
            "id,phrase",
            "1,hello world",
            "2,good   bye",
            "3,a  ok"
    ...
    def test_disable_strip_and_squeeze(self):
        self.assertLines(['--SX', '--no-strip', 'examples/strips.csv'], [
...
######## test column choice
    ...
    def test_selected_columns_normd_w_options(self):
        ...
        self.assertLines(['examples/consec_ws.csv', '-c', '2', '--SX'], [
            "id,phrase",
            "1,hello world",
            "2,good   bye",
            " 3  ,a  ok"
